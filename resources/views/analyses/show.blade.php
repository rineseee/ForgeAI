                ...
                <div class="mt-1 flex flex-wrap items-center gap-2">
                    ...
                    @if ($analysis->model_used)
                        <span
                            ...
                            title="{{ __('Different AI models can score and describe the same repository differently.') }}"
                        >
                        ...
                        >
                            ...
                            <div class="space-y-5">
                                ...
                                @if (! empty($category->improvement_examples))
                                    <div>
                                        <h4 class="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                                            <svg class="h-3.5 w-3.5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" /></svg>
